...
export default function App() {
  ...
  // Live dynamic interaction with your Render production backend
  const handlePlayerApply = async () => {
    ...
    try {
      ...
      console.error("Backend offline or waking up", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ backgroundColor: '#0b0f19', color: '#f3f4f6', minHeight: '100vh', fontFamily: 'sans-serif', paddingBottom: '40px' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, backdropFilter: 'blur(12px)', backgroundColor: 'rgba(11, 15, 25, 0.8)', borderBottom: '1px solid #1f2937', padding: '15px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 50 }}>
        <div style={{ fontWeight: 'bold', fontSize: '1.2rem', trackingLetter: '2px', color: '#10b981' }}>CRICSYNC<span style={{color:'#fff'}}>.</span></div>
      ...
      {/* 2. HERO SECTION WITH STADIUM VIBES */}
      <div style={{ background: 'linear-gradient(180deg, rgba(16,185,129,0.1) 0%, rgba(11,15,25,1) 100%)', padding: '40px 20px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginBottom: '40px' }}>
          <button style={{ backgroundColor: '#10b981', color: '#0b0f19', fontWeight: '700', border: 'none', padding: '12px 20px', borderRadius: '6px', fontSize: '0.9rem' }}>Start Tournament</button>
          <button style={{ backgroundColor: 'transparent', color: '#fff', fontWeight: '600', border: '1px solid #374151', padding: '12px 20px', borderRadius: '6px', fontSize: '0.9rem' }}>Explore Matches</button>
        </div>

        {/* 3. PREMIUM LIVE MATCH CARD (CHINNASWAMY STADIUM) */}
        <div style={{ background: '#111827', border: '1px solid #1f2937', borderRadius: '12px', maxWidth: '360px', margin: '0 auto', overflow: 'hidden', boxShadow: '0 10px 25px -5px rgba(0, 0, 0, 0.3)' }}>
          <div style={{ background: 'linear-gradient(90deg, #ef4444 0%, #3b82f6 100%)', padding: '6px 15px', fontSize: '0.75rem', fontWeight: '700', textTransform: 'uppercase', display: 'flex', justifyContent: 'space-between' }}>
            <span>Upcoming Match • Live Tracking</span>
          ...
          <div style={{ padding: '25px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <span style={{ backgroundColor: '#1f2937', padding: '3px 8px', borderRadius: '4px', fontSize: '0.7rem', color: '#10b981', fontWeight: '700' }}>T20 ENGINE</span>
            </div>
      ...
      {/* 4. ECOSYSTEM HIRING BOARD SECTION */}
      <div style={{ padding: '30px 20px', maxWidth: '360px', margin: '0 auto' }}>
        <h3 style={{ fontSize: '1.1rem', fontWeight: '700', color: '#9ca3af', marginBottom: '15px', trackingLetter: '1px' }}>LEAGUE HIRING BOARD</h3>
        
        <div style={{ backgroundColor: '#111827', border: '1px solid #1f2937', borderRadius: '10px', padding: '20px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'between', alignItems: 'center', borderTop: '1px solid #1f2937', paddingTop: '12px', marginTop: '12px' }}>
            <div>
            ...
            <button style={{ backgroundColor: '#10b981', color: '#0b0f19', border: 'none', padding: '8px 14px', borderRadius: '6px', fontSize: '0.8rem', fontWeight: '700', marginLeft: 'auto' }}>Apply Now</button>
          </div>
        </div>
      </div>
